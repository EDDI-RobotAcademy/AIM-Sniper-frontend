...
import imageSrc from "@/assets/images/fixed/home_bg.png";
...
export default defineComponent({
  ...
  methods: {
    ...
    handleParallax(event) {
      const x = (window.innerWidth - event.pageX * 0.1) / 100;
      const y = (window.innerHeight - event.pageY * 0.1) / 100;
      document.querySelector('.home-container').style.backgroundPosition = `${x}px ${y}px`;
    }
  },
